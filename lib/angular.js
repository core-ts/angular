...
var HttpRequest = (function () {
  function HttpRequest(http, getOptions) {
    this.http = http;
  ...
  HttpRequest.prototype.get = function (url, opts) {
    var x = (this.getOptions ? this.getOptions() : undefined);
    return rxjs_1.lastValueFrom(this.http.get(url, opts ? opts : x));
  };
  HttpRequest.prototype.delete = function (url, opts) {
    var x = (this.getOptions ? this.getOptions() : undefined);
    return rxjs_1.lastValueFrom(this.http.delete(url, opts ? opts : x));
  };
  HttpRequest.prototype.post = function (url, obj, opts) {
    var x = (this.getOptions ? this.getOptions() : undefined);
    return rxjs_1.lastValueFrom(this.http.post(url, obj, opts ? opts : x));
  };
  HttpRequest.prototype.put = function (url, obj, opts) {
    var x = (this.getOptions ? this.getOptions() : undefined);
    return rxjs_1.lastValueFrom(this.http.put(url, obj, opts ? opts : x));
  };
  HttpRequest.prototype.patch = function (url, obj, opts) {
    var x = (this.getOptions ? this.getOptions() : undefined);
    return rxjs_1.lastValueFrom(this.http.patch(url, obj, opts ? opts : x));
  };
  return HttpRequest;
}());
