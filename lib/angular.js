...
var HttpRequest = (function () {
  ...
  HttpRequest.prototype.get = function (url, opts) {
    return this.http.get(url, opts ? opts : this.getOptions()).toPromise();
  };
  HttpRequest.prototype.delete = function (url, opts) {
    return this.http.delete(url, opts ? opts : this.getOptions()).toPromise();
  };
  HttpRequest.prototype.post = function (url, obj, opts) {
    return this.http.post(url, obj, opts ? opts : this.getOptions()).toPromise();
  };
  HttpRequest.prototype.put = function (url, obj, opts) {
    return this.http.put(url, obj, opts ? opts : this.getOptions()).toPromise();
  };
  HttpRequest.prototype.patch = function (url, obj, opts) {
    return this.http.patch(url, obj, opts ? opts : this.getOptions()).toPromise();
  };
  return HttpRequest;
}());
