...
var BaseSearchComponent = (function (_super) {
  ...
  BaseSearchComponent.prototype.showResults = function (s, sr) {
    ...
    search_utilities_1.showResults(com, s, sr.list, sr.total, sr.last);
    if (!appendMode) {
      com.setList(results);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            else if (status_1 === st.VersionError) {
              this.showMessage(r['msg_approve_version_error']);
            }
            else if (status_1 === st.NotFound) {
              this.handleNotFound(this.form);
            }
            else {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            else if (status_2 === st.VersionError) {
              this.showMessage(r['msg_approve_version_error']);
            }
            else if (status_2 === st.NotFound) {
              this.handleNotFound(this.form);
            }
            else {
              this.showError(r['error_internal'], r['error']);
