        ...
        if (l === 0) {
          ...
          com_3.validate(obj_1, function () {
            ...
            _this.confirm(msg.message, msg.title, function () {
              com_3.save(obj_1, diffObj_1, isBack);
            }, msg.no, msg.yes);
          });
        }
      }
...
var BaseSearchComponent = (function (_super) {
  ...
  BaseSearchComponent.prototype.search = function (ft) {
    ...
    var fn = this.searchFn ? this.searchFn : this.service.search;
    var com = this;
    fn(ft, limit, next, fields).then(function (sr) {
