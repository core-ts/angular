...
var BaseComponent = (function (_super) {
  ...
  function BaseComponent(resourceService, getLocale, loading) {
...
var BaseEditComponent = (function (_super) {
  ...
  function BaseEditComponent(service, param, showMessage, showError, confirm, getLocale, uis, loading, patchable, ignoreDate, backOnSaveSuccess) {
    var _this = _super.call(this, input_1.getResource(param), input_1.getLocaleFunc(param, getLocale), input_1.getLoadingFunc(param, loading)) || this
      ...
      this.service
        ...
        .catch(function (err) {
          ...
          if (data && data.status === 404) {
            ...
            var resource = _this.resourceService.resource()
            common_1.error(err, resource, com_1.showError)
          }
          com_1.running = false
          input_1.hideLoading(com_1.loading)
        })
  ...
  BaseEditComponent.prototype.handleNotFound = function (form) {
    ...
    var resource = this.resourceService.resource()
  ...
  BaseEditComponent.prototype.doSave = function (obj, body, isBack) {
    ...
    fn(m)
      ...
      .then(function (err) {
        var resource = _this.resourceService.resource()
        common_1.error(err, resource, com.showError)
        com.running = false
        input_1.hideLoading(com.loading)
      })
  }
...
var EditComponent = (function (_super) {
  ...
  EditComponent.prototype.onInit = function () {
    ...
    var id = input_1.buildId(this.route, this.keys)
    this.load(id)
  }
...
var BaseSearchComponent = (function (_super) {
  ...
  BaseSearchComponent.prototype.searchError = function (response) {
    ...
    var resource = this.resourceService.resource()
    common_1.error(response, resource, this.showError)
  }
