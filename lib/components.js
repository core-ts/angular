...
var BaseEditComponent = (function (_super) {
    ...
    if (id && id !== '') {
      ...
      this.service.load(id).then(function (obj) {
        if (!obj) {
          ...
          com_2.newMode = false;
          com_2.orginalModel = reflectx_1.clone(obj);
  ...
  BaseEditComponent.prototype.createModel = function () {
    if (this.service.metadata) {
      ...
      if (metadata) {
        var obj_1 = edit_1.createModel(metadata);
        return obj_1;
      }
    }
    var obj = {};
...
var BaseSearchComponent = (function (_super) {
  ...
  BaseSearchComponent.prototype.mergeFilter = function (obj, b, arrs) {
    return search_utilities_1.mergeFilter(obj, b, this.pageSizes, arrs);
  };
  BaseSearchComponent.prototype.load = function (s, autoSearch) {
    this.loadTime = new Date();
    var obj2 = search_utilities_1.initFilter(s, this);
  ...
  BaseSearchComponent.prototype.getFilter = function () {
    ...
    var obj3 = search_utilities_1.optimizeFilter(obj, this, this.getFields());
    if (this.excluding) {
  ...
  BaseSearchComponent.prototype.getFields = function () {
    ...
    if (!this.initFields) {
      if (this.getSearchForm()) {
        this.fields = search_utilities_1.getFields(this.getSearchForm());
      }
  ...
  BaseSearchComponent.prototype.search = function (ft) {
    var s = reflectx_1.clone(ft);
  ...
  BaseSearchComponent.prototype.showResults = function (s, sr) {
    ...
    if (appendMode) {
      ...
      search_utilities_1.handleAppend(com, sr.list, limit, sr.nextPageToken);
      ...
      search_utilities_1.showPaging(com, sr.list, s.limit, sr.total);
      com.setList(results);
      com.tmpPageIndex = s.page;
      if (s.limit) {
        this.showMessage(search_utilities_1.buildMessage(this.resourceService, s.page, s.limit, sr.list, sr.total));
      }
    }
    this.running = false;
    core_1.hideLoading(com.loading);
    ...
    if (x && x !== '') {
      ...
      this.service.diff(_id).then(function (dobj) {
        ...
        if (data && data.status === 404) {
          ...
          core_1.error(err, com_4.resourceService.resource(), com_4.showError);
        }
        com_4.running = false;
        core_1.hideLoading(com_4.loading);
      });
