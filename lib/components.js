...
var MessageComponent = (function (_super) {
  ...
  function MessageComponent(resourceService, ui, getLocale, loading) {
...
var BaseEditComponent = (function (_super) {
  ...
  function BaseEditComponent(service, param, showMessage, showError, confirm, uis, getLocale, loading, patchable, backOnSaveSuccess) {
    var _this = _super.call(this, input_1.getResource(param), input_1.getUIService(param, uis), input_1.getLocaleFunc(param, getLocale), input_1.getLoadingFunc(param, loading)) || this;
...
var EditComponent = (function (_super) {
  ...
  function EditComponent(viewContainerRef, route, service, param, showMessage, showError, confirm, uis, getLocale, loading, patchable, backOnSaveSuccess) {
    var _this = _super.call(this, service, param, showMessage, showError, confirm, uis, getLocale, loading, patchable, backOnSaveSuccess) || this;
    _this.viewContainerRef = viewContainerRef;
    _this.route = route;
    _this.ngOnInit = _this.ngOnInit.bind(_this);
    return _this;
  ...
  EditComponent.prototype.ngOnInit = function () {
    var fi = (this.ui ? this.ui.initMaterial : null);
...
var BaseSearchComponent = (function (_super) {
  ...
  function BaseSearchComponent(sv, param, showMessage, showError, uis, getLocale, loading) {
    var _this = _super.call(this, input_1.getResource(param), input_1.getUIService(param, uis), input_1.getLocaleFunc(param, getLocale), input_1.getLoadingFunc(param, loading)) || this;
...
var SearchComponent = (function (_super) {
  ...
  function SearchComponent(viewContainerRef, sv, param, showMessage, showError, uis, getLocale, loading, autoSearch) {
    var _this = _super.call(this, sv, param, showMessage, showError, uis, getLocale, loading) || this;
    _this.viewContainerRef = viewContainerRef;
